...
public class DataviewService {
    ...
    public Map<String, Object> getDefectTypeStats() {
        ...
        // 定义皮肤癌类型映射
        // Benign-skin-cancer(良性皮肤肿瘤), Malignant-skin-cancer(恶性皮肤癌)
        Map<String, String> typeMapping = new HashMap<>();
        typeMapping.put("normal", "正常");
        // Benign-skin-cancer 良性皮肤肿瘤
        typeMapping.put("Benign-skin-cancer", "良性皮肤肿瘤");
        typeMapping.put("benign-skin-cancer", "良性皮肤肿瘤");
        // Malignant-skin-cancer 恶性皮肤癌
        typeMapping.put("Malignant-skin-cancer", "恶性皮肤癌");
        typeMapping.put("malignant-skin-cancer", "恶性皮肤癌");
        ...
        defaultStats.put("良性皮肤肿瘤", 0);
        defaultStats.put("恶性皮肤癌", 0);
        defaultStats.put("正常", 0);

        // 填充实际数据（只保留定义的类别）
        Set<String> validCategories = new HashSet<>(Arrays.asList("良性皮肤肿瘤", "恶性皮肤癌", "正常"));
